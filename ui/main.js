        ...
        if(request.readyState === XMLHttpRequest.DONE){
            ...
            if (request.status === 200) {
                ...
                for(var i=0; i<articleList.length;i++){
                    ...
                    list= list+ '<li class="list"> <p> <p><a class = "listHyp" href = "/article/'+articleList[i].heading + '">'+articleList[i].heading + '</a></p>'+ x.substring(3,100)+ '....&emsp;&emsp;&emsp;<a  class = "listHyp" href="www.google.com">Read more....</a></p></li>';
